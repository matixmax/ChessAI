...
class Generator{
public:
    Generator(vector<int8> board, vector<int8> positions, vector<int8> colors);
    ...
    static vector<Board> GetAttackMovements(const Board &chessboard, int8 color);
    static vector<Board> GetAvailableMovements(const Board &chessboard, int8 color, bool attack_movement = false);
    static vector<Board> GetPosAttackMove(const Board &chessboard, int8 target, int8 color, bool one_attack = false);
private:
	Board chessboard;
	bool attack[2];
    ...
    static vector<Board> getAttackPawnMoves(const Board &chessboard, int8 color);
    static vector<Board> getSpecialMoves(const Board &chessboard, int8 color);
    static vector<int8> getFiguresOrder(const Board &chessboard, int8 color);
